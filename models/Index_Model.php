...
class Index_Model extends Model
{
    ...
    {
        $query = $this->db->query('SELECT  k.* FROM ksiazki as k , booksgrade as b  WHERE k.id = b.bookID AND k.accept=1 GROUP BY b.bookID ORDER BY ROUND(AVG(b.grade), 1) DESC LIMIT 5');
